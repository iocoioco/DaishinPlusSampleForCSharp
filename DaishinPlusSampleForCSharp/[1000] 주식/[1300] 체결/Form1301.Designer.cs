namespace DaishinPlusSampleForCSharp._1000__주식._1300__체결
{
    partial class Form1301
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Form1301));
            ...
            // ComboBoxAccountKind
            // 
            this.ComboBoxAccountKind.BackColor = System.Drawing.Color.White;
            ...
            this.Name = "Form1301";
            this.Text = "[1301] 금일 계좌별 주문체결 내역 (CpTrade.CpTd5341)";
            this.Load += new System.EventHandler(this.Form1301_Load);
            this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.Form1301_FormClosed);
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.Form1301_KeyDown);
